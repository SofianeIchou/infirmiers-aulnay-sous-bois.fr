        ...
        for (const declarator of node.declarations) {
          if (declarator.id.type === "Identifier" && declarator.init) {
            ...
            variables.set(varName, {
              ...
              loc:
                (_a = declarator.loc) === null || _a === void 0
                  ? void 0
                  : _a.start,
            });
          }
...
const findMapContext = (node, variables) => {
  ...
  while (current && depth < maxDepth) {
    if (
      ...
      ((_a = current.callee) === null || _a === void 0 ? void 0 : _a.type) ===
        "MemberExpression" &&
      ((_c =
        (_b = current.callee) === null || _b === void 0
          ? void 0
          : _b.property) === null || _c === void 0
        ? void 0
        : _c.name) === "map"
    ) {
      // Found a .map() call, check if it's on a known array
      const arrayName =
        (_d = current.callee.object) === null || _d === void 0
          ? void 0
          : _d.name;
      const mapCallback =
        (_e = current.arguments) === null || _e === void 0 ? void 0 : _e[0];
      if (
        arrayName &&
        (mapCallback === null || mapCallback === void 0
          ? void 0
          : mapCallback.type) === "ArrowFunctionExpression"
      ) {
        const itemParam =
          (_f = mapCallback.params) === null || _f === void 0 ? void 0 : _f[0];
        const indexParam =
          (_g = mapCallback.params) === null || _g === void 0 ? void 0 : _g[1];
        if (
          (itemParam === null || itemParam === void 0
            ? void 0
            : itemParam.type) === "Identifier"
        ) {
          ...
          return {
            ...
            arrayItems:
              varInfo === null || varInfo === void 0
                ? void 0
                : varInfo.arrayItems,
            arrayLoc:
              varInfo === null || varInfo === void 0 ? void 0 : varInfo.loc,
            indexVarName:
              (indexParam === null || indexParam === void 0
                ? void 0
  ...
  try {
    ...
    (0, estree_walker_1.walk)(ast, {
      enter(node) {
        ...
        (_a = node.attributes) === null || _a === void 0
          ...
          : _a.forEach((attr) => {
              ...
              if (
                ...
                ((_a = attr.value) === null || _a === void 0
                  ? void 0
                  : _a.type) === "JSXExpressionContainer" &&
                ((_b = attr.value.expression) === null || _b === void 0
                  ? void 0
                  : _b.type) === "Identifier"
              ) {
        ...
        if (
          mapContext === null || mapContext === void 0
            ? void 0
            : mapContext.indexVarName
        ) {
          ms.appendLeft(
            node.name.end,
            ` data-map-index={${mapContext.indexVarName}}`
          );
        }
        ms.appendLeft(
          node.name.end,
